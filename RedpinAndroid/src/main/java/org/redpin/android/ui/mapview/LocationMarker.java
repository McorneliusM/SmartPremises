...
public class LocationMarker extends Button implements OnClickListener {
	...
	private void setLocation(Location l) {
		...
		Log.i("LocationMarker","setLocation : Unscaled Marker(x,y):" + unscaledX + "," + unscaledY);
     ...
     ***important code***
     * woon jiet: This code should deal with moving marker, can consider to change this code
	 */
